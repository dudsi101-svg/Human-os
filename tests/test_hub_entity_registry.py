...
class EntityRegistryTests(unittest.TestCase):
    ...
    def test_flag_and_merge_duplicates(self):
        ...
        merged = self.registry.merge(keep_entity_id=keep.entity_id, retire_entity_id=dupe.entity_id)
    ...
    def test_merge_rejects_self_merge(self):
        ...
        with self.assertRaises(ValueError):
            self.registry.merge(keep_entity_id=entity.entity_id, retire_entity_id=entity.entity_id)
