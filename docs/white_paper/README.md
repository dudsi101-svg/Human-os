# Human OS White Paper — status w repozytorium
...
Zgodnie z `02_Source_Truth_Protocol` (patrz `docs/FOUNDER_REVIEW_2026-08-15.md`):
treść poniższych plików jest transkrypcją dostarczonych PDF-ów, nie
parafrazą ani rekonstrukcją — w razie wątpliwości źródłem rozstrzygającym są
oryginalne pliki PDF u founder-a.
